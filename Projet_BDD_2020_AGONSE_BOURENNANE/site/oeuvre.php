  ...
  <body>
    ...
    <div class="container">
      ...
      if(isset($_SESSION['id']) && isset($_SESSION['mdp'])){
        ...
        $results= $cnx->prepare('SELECT nomo,affiche,noma,prenoma,realisateur,appartient.idlabbel,designation,duree,numopus,estSerie,noteglobale,datesort,synopsis,idsaga
                                FROM oeuvre 
        ...
        foreach ($results as $line) {
          ...
          <a class="oeuvre_img_container" href=<?php
                                                printf("regarde.php?idoeuvre=%s",$idoeuvre);
                                              ?>>
          ...
          <div class="details">
            ...
            <?php
              $resultsbis= $cnx->prepare('SELECT pseudo,designation,nomo 
                                          FROM suggestion 
        ...
        <ul class="casting">
          <?php
            $results= $cnx->prepare('SELECT idartiste,noma,prenoma,photoprofilea,roleartiste 
                                      FROM artiste 
                                        NATURAL JOIN joue 
