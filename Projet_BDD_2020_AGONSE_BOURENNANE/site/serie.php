    ...
    <?php
      if(isset($_SESSION['id']) && isset($_SESSION['mdp'])){
        ...
        if ($nb_ligne > 0){
          ?>
            <div class="message">
              <h1>Vous voici sur la page des séries</h1>
            </div>
              
            <h2>Séries du catalogue:</h2>
            ...
            <ul class="lst_film">
              ...
              <?php 
                ...
                $results = $cnx->query("SELECT idoeuvre,nomo,affiche,designation,prenoma,noma,synopsis
                                        FROM oeuvre 
            ...
            <h2>Séries que vous pourriez aimer:</h2>
              ...
              if(isset($_POST['form_idlabbel'])){
                ...
                <ul class="lst_film">
                  <?php 
                    ...
                    $results = $cnx->prepare("SELECT idoeuvre,nomo,affiche,labbel.idlabbel,designation,prenoma,noma,synopsis 
                                              FROM oeuvre 
                                                JOIN artiste ON oeuvre.realisateur=artiste.idartiste 
                                                NATURAL JOIN appartient 
                                                JOIN labbel ON labbel.idlabbel=appartient.idlabbel 
                                              WHERE estSerie IS TRUE AND labbel.idlabbel = :idnombre;");
